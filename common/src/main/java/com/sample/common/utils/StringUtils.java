 ...
 * class
 * <p>
 * Created by Awdhesh Jha on 23/06/2018
 */
public abstract class StringUtils {
     ...
     */
    public static boolean isValidMobileNumber(String pMobileNumber, boolean startsWithPlus, int pMinLength) {
        if (StringUtils.isNullOrEmpty(pMobileNumber)) {
            return false;
        }
        pMobileNumber = pMobileNumber.trim();
        if (startsWithPlus && !pMobileNumber.startsWith("+")) {
            return false;
        }
